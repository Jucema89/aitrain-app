...
import { SvgAitrainLogoPhone } from "../../../../public/svg";
    ...
    return(
        ...
        <nav className="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Global">
          <div className="me-5 lg:me-0 lg:hidden">
            <a className="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="/" aria-label="Aitrain Platform">
                <SvgAitrainLogoPhone />
            </a>
          </div>
