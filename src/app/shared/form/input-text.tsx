...
export default function InputText (data: InputTextProps) {
    ...
    <div className="grid sm:grid-cols-4 sm:gap-2 py-2">
        ...
        <div className="relative flex  sm:col-span-9">
            <input id={data.id} name={data.name} type={data.type} placeholder={data.placeholder} {...data.registerZod(data.id)} className={data.errorMessage != '' ? errorClass : normalClass} aria-describedby="hs-validation-name-error-helper"/>
